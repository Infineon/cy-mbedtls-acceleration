# mbedTLS Crypto PSA acceleration for CAT1B MCUs
...
1. Create `Empty_App` project using ModusToolbox.
   ...
   _**Note:** If you want to enable the standard input output over UART create Hello_World project from ModusToolbox instead of Empty_App project. CAT1B devices Empty_App supports standard input output over UART._
...
This code example demonstrates MbedTLS PSA-SHA driver capabilities using the cryptographic hardware block of CAT1B MCUs.
...
### More information
* [CAT1B MCUs acceleration for mbedTLS library RELEASE information][RELEASE]
