...
/***************************************************************************//**
* \file ifx_cryptolite_transparent_key_agreement.h
*
* \brief
...
#if !defined(IFX_CRYPTOLITE_TRANSPARENT_KEY_AGREEMENT_H)
#define IFX_CRYPTOLITE_TRANSPARENT_KEY_AGREEMENT_H
...
#endif /* #if !defined (IFX_CRYPTOLITE_TRANSPARENT_KEY_AGREEMENT_H) */
