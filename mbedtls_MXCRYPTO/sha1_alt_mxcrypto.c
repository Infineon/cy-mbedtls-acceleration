...
void mbedtls_sha1_init( mbedtls_sha1_context *ctx )
{
    ...
    ctx->shaBuffers = (cy_stc_crypto_v1_sha1_buffers_t*)CY_CRYPTO_DCACHE_ALIGN_ADDRESS((size_t)ctx->shaBuffers_t);
#else
    ctx->shaBuffers = (cy_stc_crypto_v2_sha1_buffers_t*)CY_CRYPTO_DCACHE_ALIGN_ADDRESS((size_t)ctx->shaBuffers_t);
#endif
...
#if (CY_IP_MXCRYPTO_VERSION == 1u)
    dst->shaBuffers = (cy_stc_crypto_v1_sha1_buffers_t*)CY_CRYPTO_DCACHE_ALIGN_ADDRESS((size_t)dst->shaBuffers_t);
	ifx_mbedtls_memcpy((void *)dst->shaBuffers, (void *)src->shaBuffers, sizeof(cy_stc_crypto_v1_sha1_buffers_t));
#else
    dst->shaBuffers = (cy_stc_crypto_v2_sha1_buffers_t*)CY_CRYPTO_DCACHE_ALIGN_ADDRESS((size_t)dst->shaBuffers_t);
