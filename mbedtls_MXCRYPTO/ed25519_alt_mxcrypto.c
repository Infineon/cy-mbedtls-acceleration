                ...
                int (*f_rng)(void *, unsigned char *, size_t), void *p_rng )
{
    ...
    key.k = (uint8_t*)CY_CRYPTO_DCACHE_ALIGN_ADDRESS((size_t)key_ptr);
    ...
    sig = (uint8_t*)CY_CRYPTO_DCACHE_ALIGN_ADDRESS((size_t)sig_ptr);
                          ...
                          const unsigned char *ed_ctx, size_t ed_ctx_len )
{
    ...
    key.pubkey.y  = (uint8_t*)CY_CRYPTO_DCACHE_ALIGN_ADDRESS((size_t)point_arr) + bytesize;
