                         ...
                         mbedtls_ecp_restart_ctx *rs_ctx )
{
    ...
    if( !CY_MBTLS_IS_MEM_CACHABLE_ALIGNED((uint32_t)Pi.X.p, param_byte_size))
	{
        ...
        aligned_PiXp_data = (uint8_t*)CY_CRYPTO_DCACHE_ALIGN_ADDRESS((size_t)(PiXp_data));
    ...
    if( !CY_MBTLS_IS_MEM_CACHABLE_ALIGNED((uint32_t)Pi.Y.p, param_byte_size))
	{
        ...
        aligned_PiYp_data = (uint8_t*)CY_CRYPTO_DCACHE_ALIGN_ADDRESS((size_t)(PiYp_data));
    ...
    if( !CY_MBTLS_IS_MEM_CACHABLE_ALIGNED((uint32_t)di.p, param_byte_size))
	{
        ...
        aligned_dip_data = (uint8_t*)CY_CRYPTO_DCACHE_ALIGN_ADDRESS((size_t)(dip_data));
    ...
    if( !CY_MBTLS_IS_MEM_CACHABLE_ALIGNED((uint32_t)R->X.p, param_byte_size))
	{
        ...
        aligned_RXp_data = (uint8_t*)CY_CRYPTO_DCACHE_ALIGN_ADDRESS((size_t)(RXp_data));
	}
    if( !CY_MBTLS_IS_MEM_CACHABLE_ALIGNED((uint32_t)R->Y.p, param_byte_size))
	{
        ...
        aligned_RYp_data = (uint8_t*)CY_CRYPTO_DCACHE_ALIGN_ADDRESS((size_t)(RYp_data));
	}
...
#if defined(MBEDTLS_ECP_MONTGOMERY_ENABLED)
#if defined(MBEDTLS_ECP_DP_CURVE25519_ENABLED)
#define ECP_MPI_INIT(s, n, p) {(mbedtls_mpi_uint *)(p), s, (n)}
