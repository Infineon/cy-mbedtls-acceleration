...
/***************************************************************************//**
* \file ifx_cryptolite_transparent_sign.h
*
* \brief
...
#if !defined(IFX_CRYPTOLITE_TRANSPARENT_SIGNATURE_H)
#define IFX_CRYPTOLITE_TRANSPARENT_SIGNATURE_H
...
#endif /* defined(IFX_PSA_CRYPTOLITE_ECDSA_SIGN) || defined(IFX_PSA_CRYPTOLITE_RSA_SIGN) */

#endif /* #if !defined (IFX_CRYPTOLITE_TRANSPARENT_SIGNATURE_H) */
