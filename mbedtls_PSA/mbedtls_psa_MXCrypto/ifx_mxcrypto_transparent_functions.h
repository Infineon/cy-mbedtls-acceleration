...
/***************************************************************************//**
* \file ifx_mxcrypto_transparent_functions.h
*
* \brief
...
#if !defined(IFX_MXCRYPTO_TRANSPARENT_FUNCS_H)
#define IFX_MXCRYPTO_TRANSPARENT_FUNCS_H
...
#endif /* #if !defined (IFX_MXCRYPTO_TRANSPARENT_FUNCS_H) */
