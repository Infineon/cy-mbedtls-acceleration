...
/***************************************************************************//**
* \file ifx_mxcrypto_transparent_signature_verify.h
*
* \brief
...
#if !defined(IFX_MXCRYPTO_TRANSPARENT_SIGNATURE_VERIFY_H)
#define IFX_MXCRYPTO_TRANSPARENT_SIGNATURE_VERIFY_H
...
#endif /* defined(IFX_PSA_MXCRYPTO_ECDSA_VERIFY) || defined(IFX_PSA_MXCRYPTO_RSA_VERIFY) */

#endif /* #if !defined (IFX_MXCRYPTO_TRANSPARENT_SIGNATURE_VERIFY_H) */
