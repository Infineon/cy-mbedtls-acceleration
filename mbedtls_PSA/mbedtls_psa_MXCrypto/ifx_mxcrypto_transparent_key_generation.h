...
/***************************************************************************//**
* \file ifx_mxcrypto_transparent_key_generation.h
*
* \brief
...
#if !defined(IFX_MXCRYPTO_TRANSPARENT_KEY_GENERATION_H)
#define IFX_MXCRYPTO_TRANSPARENT_KEY_GENERATION_H
...
#endif /* #if !defined (IFX_MXCRYPTO_TRANSPARENT_KEY_GENERATION_H) */
