...
/***************************************************************************//**
* \file ifx_cryptolite_transparent_key_generation.h
*
* \brief
...
#if !defined(IFX_CRYPTOLITE_TRANSPARENT_KEY_GENERATION_H)
#define IFX_CRYPTOLITE_TRANSPARENT_KEY_GENERATION_H
...
#endif /* #if !defined (IFX_CRYPTOLITE_TRANSPARENT_KEY_GENERATION_H) */
